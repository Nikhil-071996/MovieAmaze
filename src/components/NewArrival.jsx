...
function NewArrival(props) {
    ...
    async function  fetchMovies(){
        let res = await fetch(`https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=${process.env.REACT_APP_API_KEY}&language=en-US&page=1`)
        let data = await res.json()
        setNewArrival(data.results)
    }
